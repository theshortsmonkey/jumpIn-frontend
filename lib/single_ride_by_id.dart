...
class _SingleRideByIDState extends State<SingleRideByID> {
  ...
  Future<void> _getRideChats() async {
    List<Chat> chats = await fetchMessagesByRideId(rideId, currUser.username);
    setState(() {
      _rideChats = chats;
    });
  }
                            ...
                            child: Row(
                              children: [
                                IntrinsicWidth(
                                  child: Column(
                                    children: [
                                      itemProfile('Start', '${_currRide.from}',
